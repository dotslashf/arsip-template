...
import { ArrowRight, Clipboard, ImageIcon, Link2, Minus, Plus, Type } from "lucide-react";
...
export default function CardSearchCollection({ copyPasta, onAddToCollection, onRemoveFromCollection, type }: CardSearchCollectionProps) {
  ...
  return (
    <Card className="w-full h-full">
      ...
      <CardFooter className="self-end flex flex-col items-start gap-4 text-sm text-secondary-foreground dark:text-muted-foreground">
