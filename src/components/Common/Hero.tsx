    ...
    >
      <div className="z-30 flex w-full flex-grow flex-col items-center justify-center text-center">
        <Link
          href={"/"}
          className={cn(
            `duration-3000 mb-4 inline animate-gradient bg-white bg-gradient-to-r from-primary via-primary/60 to-primary bg-[length:var(--bg-size)_100%] bg-clip-text text-5xl font-bold text-transparent ease-out [--bg-size:300%]`,
          )}
        >
          arsip
          <br />
