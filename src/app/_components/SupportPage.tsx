        ...
        <CardContent className="flex flex-col items-center space-y-4">
          <div className="max-w-md space-y-4 text-center">
            ...
            <p>
              ...
              gue untuk terus menjalankan platform ini.
            </p>
            <p>
              Dukungan kalian nggak cuma bantu platform ini tetap jalan, tapi
              juga kasih gue semangat buat terus berkarya dan mengembangkan
              fitur-fitur seru lainnya.
            </p>
